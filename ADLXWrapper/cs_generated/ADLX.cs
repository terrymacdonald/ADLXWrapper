...
namespace ADLXWrapper
{
    public static unsafe partial class ADLX
    {
        ...
        [DllImport("amdadlx64.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "?adlx_atomic_inc@@YAJPEAJ@Z", ExactSpelling = true)]
        [return: NativeTypeName("adlx_long")]
        public static extern int adlx_atomic_inc([NativeTypeName("adlx_long *")] int* x);

        [DllImport("amdadlx64.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "?adlx_atomic_dec@@YAJPEAJ@Z", ExactSpelling = true)]
        [return: NativeTypeName("adlx_long")]
        public static extern int adlx_atomic_dec([NativeTypeName("adlx_long *")] int* x);

        [DllImport("amdadlx64.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "?adlx_load_library@@YAPEAXPEBD@Z", ExactSpelling = true)]
        [return: NativeTypeName("adlx_handle")]
        public static extern void* adlx_load_library([NativeTypeName("const TCHAR *")] sbyte* filename);

        [DllImport("amdadlx64.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "?adlx_free_library@@YAHPEAX@Z", ExactSpelling = true)]
        public static extern int adlx_free_library([NativeTypeName("adlx_handle")] void* module);

        [DllImport("amdadlx64.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "?adlx_get_proc_address@@YAPEAXPEAXPEBD@Z", ExactSpelling = true)]
