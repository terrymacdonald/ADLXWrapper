...
public unsafe partial struct IADLXGPUMetrics2
{
    ...
    public delegate int _Acquire(IADLXGPUMetrics2* pThis);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: NativeTypeName("adlx_long")]
    public delegate int _Release(IADLXGPUMetrics2* pThis);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _QueryInterface(IADLXGPUMetrics2* pThis, [NativeTypeName("const wchar_t *")] ushort* interfaceId, void** ppInterface);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _TimeStamp(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int64 *")] long* ms);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUUsage(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_double *")] double* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUClockSpeed(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int *")] int* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUVRAMClockSpeed(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int *")] int* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUTemperature(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_double *")] double* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUHotspotTemperature(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_double *")] double* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUPower(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_double *")] double* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUTotalBoardPower(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_double *")] double* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUFanSpeed(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int *")] int* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUVRAM(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int *")] int* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUVoltage(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int *")] int* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUIntakeTemperature(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_double *")] double* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUMemoryTemperature(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_double *")] double* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _NPUFrequency(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int *")] int* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _NPUActivityLevel(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int *")] int* data);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ADLX_RESULT _GPUSharedMemory(IADLXGPUMetrics2* pThis, [NativeTypeName("adlx_int *")] int* data);

    [return: NativeTypeName("adlx_long")]
    public int Acquire()
    {
        fixed (IADLXGPUMetrics2* pThis = &this)
        {
    ...
    public ADLX_RESULT GPUSharedMemory([NativeTypeName("adlx_int *")] int* data)
    {
        fixed (IADLXGPUMetrics2* pThis = &this)
        {
            return Marshal.GetDelegateForFunctionPointer<_GPUSharedMemory>((IntPtr)(lpVtbl[18]))(pThis, data);
        }
    }
}
