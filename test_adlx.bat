@echo off
echo Building C# ADLX Test Application (.NET 9.0)...
echo Using dotnet CLI for .NET 9.0 build and execution
...
if %ERRORLEVEL% NEQ 0 (
    ...
    echo Please ensure .NET 9.0 SDK is installed
...
REM Check .NET 9.0 SDK availability
echo Checking for .NET 9.0 SDK...
dotnet --list-sdks | findstr "9.0" >nul 2>&1
if %ERRORLEVEL% NEQ 0 (
...
echo .NET 9.0 SDK found successfully
echo.
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo IADLXGPU2Test_Net9.dll/.exe created using .NET 9.0 SDK
    echo.
